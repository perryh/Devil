...
//FUNCPTR(D2CLIENT, RecvCommand07, void __fastcall, (BYTE *cmdbuf), 0x6FB14920)  //1.12 D2Loader Banned
FUNCPTR(D2CLIENT, RecvCommand07, void __fastcall, (BYTE *cmdbuf), 0x64920)  //1.12 Original Diablo II.exe
//FUNCPTR(D2CLIENT, RecvCommand08, void __fastcall, (BYTE *cmdbuf), 0x6FB148B0)  //1.12 Banned D2Loader
FUNCPTR(D2CLIENT, RecvCommand08, void __fastcall, (BYTE *cmdbuf), 0x648B0)  //1.12
...
//mouse
//FUNCPTR(D2CLIENT, xGetNextPartyPlayer, RosterUnit * __fastcall, (RosterUnit *pla), 0x77E40/*0x6FB27E40 6FADDBC0*/)
FUNCPTR(D2CLIENT, xGetNextPartyPlayer, PartyPlayer * __fastcall, (PartyPlayer *pla), 0x77E40/*0x6FB27E40 6FADDBC0*/)
//extra
...
//FUNCPTR(D2CLIENT, SimulateClick, DWORD __stdcall, (DWORD Unknown, DWORD x, DWORD y, DWORD Mode), 0x5CE80)  // me
...
VARPTR(D2CLIENT, Skip, DWORD, 0x1032C8)
...
VARPTR(D2CLIENT, fAutomapOn, DWORD, 0x102B80)
...
ASMPTR(D2CLIENT, OverrideShrinePatch_ORIG, 0x16A72)
...
FUNCPTR(D2COMMON, GetUnitState2, int __stdcall, (UnitAny* pUnit, DWORD dwStat, DWORD unknown), -10658) // Added
FUNCPTR(D2COMMON, GetUnitState3,int __stdcall, (DWORD unknown, DWORD unknown2), -10680) // Added // 10152 10680
/*
		DEFEXP(D2COMMON,GetUnitState2,10550)
		DEFEXP(D2COMMON,GetUnitState3,10152) 
...
FUNCPTR(D2COMMON, GetQuestFlag, INT __stdcall, (VOID* QuestInfo, DWORD dwQuest, DWORD dwFlag), -10600) // Updated
...
VARPTR(D2CLIENT, PlayerList, RosterUnit *, 0x11C080) //added
//VARPTR(D2CLIENT, pUnitTable, POINT, 0x6FBCA960) //added d2loader
...
FUNCPTR(D2NET, SendPacket, void __stdcall, (DWORD aLen, DWORD arg1, BYTE* aPacket), -10036) // Updated
...
ASMPTR(D2CLIENT, GetUnitFromId_I, 0x11A960)
ASMPTR(D2CLIENT, GetUnitFromId_II, 0x1E550)
...
VARPTR(D2CLIENT, AutomapOn, DWORD, 0x102B80)  // me
...
FUNCPTR(D2WIN, DestroyEditBox, DWORD __fastcall, (Control* box), -10155) 
...
FUNCPTR(D2WIN, SetEditBoxProc, void __fastcall, (Control* box, BOOL (__stdcall *FunCallBack)(Control*,DWORD,DWORD)), -10113) 
FUNCPTR(D2WIN, SelectEditBoxText, void __fastcall, (Control* box), -10035) 
FUNCPTR(D2CLIENT, DrawEnteringLevelText, void __stdcall, (), 0x8BDA0)
FUNCPTR(D2CLIENT, DrawManaOrb, void __stdcall, (), 0x81BB0)
FUNCPTR(D2CLIENT, DrawStamina, void __stdcall, (), 0x3C1F0)
FUNCPTR(D2CLIENT, DrawStaminaA, void __stdcall, (), 0x3BFB0)

//
VARPTR(D2CLIENT, ServerIp, char, 0xDFFB0/*0x6FB8FFB0*/)
//VARPTR(D2CLIENT, pAct, Act *, 0x6FBCC01C) //me // 0x11C2D0+6FAB0000 = 6FBCC2D0 d2loader
VARPTR(D2CLIENT, pAct, Act *, 0x11c01c) //me // 0x11C2D0+6FAB0000 = 6FBCC2D0
...
#define GetUnit(dwId, dwType)				((UnitAny* )GetUnit_STUB(dwId, dwType))
...
#define Myself						 (*p_D2CLIENT_PlayerUnit)
